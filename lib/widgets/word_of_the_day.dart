...
import 'package:lingo/modules/daily_word.dart';
  ...
  Future<String> generateRandomWord() async {
    try {
      final response = await Dio()
          .get(randomWordUrl, options: Options(headers: {"X-Api-Key": "s2fEd98mfx6coxYzJ28iVA==2hA1O1bK24lpNP5n"}));
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        for (var meaning in data['meanings']) {
          ...
          meanings.add(Meaning(partOfSpeech: meaning['partOfSpeech'], definitions: definitions));
        }
        List phonetics = data['phonetics'];
        String audio = phonetics.firstWhere((element) => element['audio'] != '')['audio'];
          ...
          builder: (context, snapshot) {
            ...
            if (snapshot.hasError) {
              return const Padding(
                padding: EdgeInsets.all(15),
                child: Center(
                  child: Text("We are sorry, we couldn't get the word of the day."),
                ),
              );
            }
            final DailyWord dailyWord = snapshot.data as DailyWord;
            List<String?> examples = dailyWord.meanings
                .map((meaning) => meaning.definitions.map((definition) => definition.example).toList())
                              ...
                              child: SingleChildScrollView(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    ...List.generate(dailyWord.meanings.length, (index) {
                                      ...
                                      return Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            ...List.generate(meaning.definitions.length, (index) {
